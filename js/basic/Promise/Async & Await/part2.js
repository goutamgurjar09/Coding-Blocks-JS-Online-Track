...
//await ka use hm jb bhi server se data fetch krte hai tb krte hai
//https://api.tvmaze.com/search/shows?q=girls

// async function test(){
//     console.log("api data loading.....")   //first this will print
//    let responce = await fetch('https://api.tvmaze.com/search/shows?q=girls');  //await means yha waith kijie or data fetch nhi hota tb tk    //fetch method data json/text formet me deta hai

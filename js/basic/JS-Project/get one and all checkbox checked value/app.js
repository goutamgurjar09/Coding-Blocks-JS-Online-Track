...
//this fun  will simply do  all checkbox value set to true and
//This function selects all checkboxes with the class (pl) when the "Check all" button is clicked.
...
//this fun will get all checkbox value if all/any of them checkbox is checked to true and display in result div when the "Submit" button is clicked.

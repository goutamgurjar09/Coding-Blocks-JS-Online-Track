...
//The FormData object does appear empty in the console log because it doesn't automatically display its contents when logged. However, you can access the individual form fields using various methods provided by the FormData object.

//------------
//* Object.fromEntries()

//Certainly! The Object.fromEntries() method is used to transform a list of key-value pairs (as arrays) into an object. In the context of your code, it can be used to convert the entries of the FormData object into a regular JavaScript object
